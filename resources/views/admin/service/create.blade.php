                    ...
                    <div class="card-body">
                        <form action="{{route('services.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" name="name" value="{{old('name')}}" id="productName" type="text" placeholder="" />
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" name="title" value="{{old('title')}}" id="productName" type="text" placeholder="" />
